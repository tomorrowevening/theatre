...
import type {IScrub, IStudio} from '@tomorrowevening/theatre-studio'
import type {ShorthandCompoundPropsToInitialValue} from '@tomorrowevening/theatre-core/propTypes/internals'
