...
import type {IConnectorThemeValues} from '@tomorrowevening/theatre-studio/panels/SequenceEditorPanel/DopeSheet/Right/keyframeRowUI/ConnectorLine'
  ...
  return (
    <>
      <ConnectorLine
        ...
        {...themeValues}
        isPopoverOpen={themeValues.$isPopoverOpen}
        isSelected={themeValues.$isSelected}
        openPopover={(e) => {
